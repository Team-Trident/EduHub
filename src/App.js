    ...
    <div className={classes.container}>
      ...
      <AppBar position="fixed" color="#cae8f6" elevation="8"   className={classes2.appBar}>
        ...
        <img src={logo} onClick={() => history.push('/')} alt="EduHub" width="150" height="95"/>
          <Button color="inherit" id="btn" onClick={() => history.push('/AboutUs')}>About Us</Button>
          <Button color="inherit" id="signup-btn" onClick={() => history.push('/SignUp')}>Login/Sign Up</Button>
        </Toolbar>
      </AppBar>
      </div>
    </div>
