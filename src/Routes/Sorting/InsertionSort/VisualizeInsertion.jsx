...
render() {
  ...
  return (
    <div>
    <div>
    <Button onClick={()=>this.resetArray()}  disabled={this.state.disabled} id="btn8">New array</Button>
    <a>Array Bar:</a>
    <Slider
    ...
    <Slider
            ...
            disabled={this.state.disabled}
          />
    <Button  disabled={this.state.disabled} onClick={()=>this.startSorting()} id="btn9">Run Sorting</Button>
    <hr></hr>
    </div>
