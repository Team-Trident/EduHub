...
render() {
  ...
  <Container id="z" groupName="1" style={groupStyle} orientation="horizontal" getChildPayload={i => this.state.items3[i]} onDrop={e => {this.setState({array: applyDrag("array",this.state.array,this.state.items3, e)}); this.messageCallSet()}}>
    {array.map((value, idx) => (
      <Draggable>
        <div
